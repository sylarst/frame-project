...
import net.caixiaomi.smartrefresh.layout.listener.CoordinatorLayoutListener;
import net.caixiaomi.smartrefresh.layout.util.DesignUtil;
import net.caixiaomi.smartrefresh.layout.util.ScrollBoundaryUtil;
import net.caixiaomi.smartrefresh.layout.util.SmartUtil;
