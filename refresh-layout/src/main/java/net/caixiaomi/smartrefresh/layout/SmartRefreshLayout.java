package net.caixiaomi.smartrefresh.layout;
...
import net.caixiaomi.smartrefresh.layout.api.DefaultRefreshFooterCreator;
import net.caixiaomi.smartrefresh.layout.api.DefaultRefreshHeaderCreator;
import net.caixiaomi.smartrefresh.layout.api.RefreshContent;
import net.caixiaomi.smartrefresh.layout.api.RefreshFooter;
import net.caixiaomi.smartrefresh.layout.api.RefreshHeader;
import net.caixiaomi.smartrefresh.layout.api.RefreshInternal;
import net.caixiaomi.smartrefresh.layout.api.RefreshKernel;
import net.caixiaomi.smartrefresh.layout.api.RefreshLayout;
import net.caixiaomi.smartrefresh.layout.api.ScrollBoundaryDecider;
import net.caixiaomi.smartrefresh.layout.constant.DimensionStatus;
...
import net.caixiaomi.smartrefresh.layout.footer.BallPulseFooter;
import net.caixiaomi.smartrefresh.layout.header.BezierRadarHeader;
import net.caixiaomi.smartrefresh.layout.impl.RefreshContentWrapper;
import net.caixiaomi.smartrefresh.layout.impl.RefreshFooterWrapper;
import net.caixiaomi.smartrefresh.layout.impl.RefreshHeaderWrapper;
import net.caixiaomi.smartrefresh.layout.listener.OnLoadMoreListener;
import net.caixiaomi.smartrefresh.layout.listener.OnMultiPurposeListener;
import net.caixiaomi.smartrefresh.layout.listener.OnRefreshListener;
import net.caixiaomi.smartrefresh.layout.listener.OnRefreshLoadMoreListener;
import net.caixiaomi.smartrefresh.layout.listener.OnStateChangedListener;
import net.caixiaomi.smartrefresh.layout.util.DelayedRunnable;
import net.caixiaomi.smartrefresh.layout.util.DensityUtil;
import net.caixiaomi.smartrefresh.layout.util.ScrollBoundaryUtil;
import net.caixiaomi.smartrefresh.layout.util.ViscousFluidInterpolator;
...
import static net.caixiaomi.smartrefresh.layout.util.DensityUtil.dp2px;
import static net.caixiaomi.smartrefresh.layout.util.SmartUtil.fling;
import static net.caixiaomi.smartrefresh.layout.util.SmartUtil.getColor;
import static net.caixiaomi.smartrefresh.layout.util.SmartUtil.isScrollableView;
...
//        this.mFooterExtendHeight = (int) Math.max((mFooterHeight * (mFooterMaxDragRate - 1)), 0);
    ...
    /**
     * 设置多功能监听器
     * @param listener 建议使用 {@link net.caixiaomi.smartrefresh.layout.listener.SimpleMultiPurposeListener}
     * @return SmartRefreshLayout
     */
    @Override
    ...
    /**
     * 设置滚动边界
     * @param boundary 建议使用 {@link net.caixiaomi.smartrefresh.layout.impl.ScrollBoundaryDeciderAdapter}
     * @return SmartRefreshLayout
     */
    @Override
