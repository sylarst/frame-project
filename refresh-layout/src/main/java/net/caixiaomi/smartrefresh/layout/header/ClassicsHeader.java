...
import net.caixiaomi.smartrefresh.layout.internal.ArrowDrawable;
import net.caixiaomi.smartrefresh.layout.internal.InternalClassics;
import net.caixiaomi.smartrefresh.layout.internal.ProgressDrawable;
...
//    public static String REFRESH_HEADER_UPDATE = "'Last update' M-d HH:mm";
    ...
    public ClassicsHeader(Context context, AttributeSet attrs, int defStyleAttr) {
        ...
        lpProgress.rightMargin = ta.getDimensionPixelSize(R.styleable.ClassicsFooter_srlDrawableMarginRight, density.dip2px(16));
